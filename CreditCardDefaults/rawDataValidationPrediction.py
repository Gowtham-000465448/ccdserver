...
class Raw_Data_validation:
    ...
    def valuesFromSchema(self):
        ...
        try:
            ...
            column_names.popitem()
            numberofColumns = fileObj['NumberofColumns']-1
    ...
    def createDirectoryForGoodBadRawData(self):
        ...
        try:
            path = os.path.join("Prediction_Raw_files_validated/", "PredictionFiles/")
    ...
    def validationFileNameRaw(self,regex,LengthOfDateStampInFile,LengthOfTimeStampInFile):
        ...
        try:
            f = open("Prediction_Logs/Prediction_Log.txt", 'a+')
                ...
                if (re.match(regex, filename)):
                    ...
                    if len(splitAtDot[1]) == LengthOfDateStampInFile:
                        if len(splitAtDot[2]) == LengthOfTimeStampInFile:
                            shutil.copy(file_path +"\\"+ filename, "Prediction_Raw_files_validated/PredictionFiles")
    ...
    def validateColumnLength(self,NumberofColumns):
        ...
        try:
            ...
            for file in listdir('Prediction_Raw_files_validated/PredictionFiles/'):
                csv = pd.read_csv("Prediction_Raw_files_validated/PredictionFiles/" + file)
        ...
        try:
            ...
            for file in listdir('Prediction_Raw_files_validated/PredictionFiles/'):
                ...
                if count==0:
                    ...
                    csv.to_csv("Prediction_Raw_files_validated/PredictionFiles/" + file, index=None, header=True)
        except OSError:
            f = open("Prediction_Logs/Prediction_Log.txt", 'a+')
            self.logger.log(f, "Error Occured while moving the file :: %s" % OSError)
            f.close()
